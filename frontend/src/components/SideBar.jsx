...
const handleCreateConversation = async () => {
 ...
 dispatch(addConversation(data))
  ...
  if(collapsed){
    return (
      <div className='fixed lg:static inset-y-0 left-0 z-50 h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06] w-[70px] transition-[width] duration-300 ease-in-out overflow-hidden'>
  ...
  return (
    <div className='fixed lg:static inset-y-0 left-0 z-50 w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06] transition-[width] duration-300 ease-in-out'>
